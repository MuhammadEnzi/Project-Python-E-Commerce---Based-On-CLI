...
def Penyimpanan_Item_Produk():
    Item_Produk = {
        ...
        "Monitor": [
            #              Jenis Item             Harga
            {"Nama_Item": "MSI", "Harga": 3000000},
            {"Nama_Item": "LG", "Harga": 1000000},
            {"Nama_Item": "SAMSUNG", "Harga": 4000000},
        ],
        "Laptop": [
            {"Nama_Item": "MACBOOK", "Harga": 66000000},
            {"Nama_Item": "ASUS ROG", "Harga": 74000000},
            {"Nama_Item": "LENOVO", "Harga": 12000000},
        ],
        "Webcam": [
            {"Nama_Item": "LOGITECH RALLY", "Harga": 10000000},
            {"Nama_Item": "OBSBOT", "Harga": 5000000},
            {"Nama_Item": "ITCAM", "Harga": 3000000},
        ],
        "Keyboard": [
            {"Nama_Item": "FANTECH", "Harga": 195000},
            {"Nama_Item": "RED DRAGON", "Harga": 440000},
            {"Nama_Item": "GAMEN", "Harga": 222000},
        ],
        "Mouse": [
            {"Nama_Item": "LOGITECH", "Harga": 1600000},
            {"Nama_Item": "REZER", "Harga": 1100000},
            {"Nama_Item": "ASUS", "Harga": 1800000},
        ],
    }
    return Item_Produk
                ...
                while True:
                    try:
                        ...
                        if keputusan_user == 1:
                            ...
                            while True:
                                ...
                                try: 
                                    if jenis_pembayaran == 1:
                                        ...
                                        status_pengiriman = "Produk sedang dikemas penjual"
                                        #threading.Thread(target=update_status_pengiriman, args=(,)).start()
                            ...
                            simpan_ke_kantong_belanja(jenis_produk,produk_terpilih['Nama_Item'],produk_terpilih['Harga'], jumlah, total_harga)
                            waktu(2)
